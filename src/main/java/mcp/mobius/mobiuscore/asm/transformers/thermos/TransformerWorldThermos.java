package mcp.mobius.mobiuscore.asm.transformers.thermos;
...
import static mcp.mobius.mobiuscore.asm.transformers.TransformerBase.dumpChecksum;
...
public class TransformerWorldThermos extends TransformerBase{
	...
	static{
		...
		WORLD_PATTERN_LOADEDENTS = new  AbstractInsnNode[]
			{
				Opcode.ALOAD(0),
				Opcode.NEW("thermos/chaud/HashedArrayList"),
				Opcode.DUP(),
				Opcode.INVOKESPECIAL("thermos/chaud/HashedArrayList", "<init>", "()V"),

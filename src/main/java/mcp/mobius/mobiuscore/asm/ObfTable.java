...
public enum ObfTable {
	...
	*/
    ...
    public static ServerType getServerType() throws Exception {
        if (serverType != null) {
            return serverType;
        }
        ...
        if (FMLCommonHandler.instance().getModName().contains("thermos")) {
            ...
            throw new Exception("This fixed version isn't for KCauldron. You have to download right fixed version!");
        }
